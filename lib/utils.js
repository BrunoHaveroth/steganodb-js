...
module.exports = {
  ...
  generateRegistryPath: function(collection, currentPath, configs, keepImage) {
    var collectionPath = this.getCollectionPath(collection, configs),
      ...
      var promise = keepImage ? fs.copy(currentPath, newPath) : fs.rename(currentPath, newPath);
  ...
  updateRegistryPath: function(collection, currentPath, collectionId, configs) {
    var collectionPath = this.getCollectionPath(collection, configs);
      newPath = collectionPath + collectionId + '.png';
